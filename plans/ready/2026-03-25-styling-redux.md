...
- [ ] Fix bug where wide URLs push the button out of the frame
- [ ] Make completed tasks smaller and make the checkbox a subtle gray
- [ ] Only show the + button in the input when the user starts typing
- [ ] Make the input textbox grow to fit the text (multiline, up to 4 lines)
