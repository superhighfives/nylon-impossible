...
export function Checkbox({
  ...
  const checkedStyle =
    variant === "subtle"
      ...
      : "data-checked:bg-yellow-9 data-checked:border-yellow-9 data-checked:text-gray-12 dark:data-checked:bg-yellowdark-9 dark:data-checked:border-yellowdark-9 data-indeterminate:bg-yellow-9 data-indeterminate:border-yellow-9 data-indeterminate:text-gray-12 dark:data-indeterminate:bg-yellowdark-9 dark:data-indeterminate:border-yellowdark-9";
